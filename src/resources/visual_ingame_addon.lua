...
local ingame_sprite_data_t = transform(
  {
    ...
    -- parameters:                        {id_loc(2), span(2), pivot(2), transparent_color}

    -- palm tree extension sprites
    -- top pivot is located at top-left of core
    palm_tree_leaves_top                = {   12, 12,    1, 2,    0, 16,       colors.pink},
    ...
    palm_tree_leaves_right              = {   13, 12,    3, 4,    0, 16,       colors.pink},

    -- RUNTIME SPRITES (stage-specific and common runtime)
    -- below need runtime sprites to be reloaded, overwriting collision masks
    background_forest_bottom_hole       = {     1, 0,    2, 3,    0,  0,       colors.pink},
    background_forest_bottom_lightshaft = {    13, 1,    3, 2,    0,  0,       colors.pink},
    emerald_silhouette                  = {     9, 1,    1, 1,    3,  2,       colors.pink},
    goal_plate_goal                     = {     3, 0,    3, 2,   12, 16,       colors.pink},
    goal_plate_sonic                    = {     6, 0,    3, 2,   12, 16,       colors.pink},
    goal_plate_rotating_90              = {     0, 1,    1, 2,    4, 16,       colors.pink},
    ...
    goal_plate_rotating_45_ccw          = {    6, 14,    2, 2,    7, 16,       colors.pink},
    goal_plate_rotating_45_cw           = {    8, 14,    2, 2,    8, 16,       colors.pink},

    -- emerald representation tile (left part) and object sprite (both parts)
    emerald                             = {   10, 15,    1, 1,     3, 2,       colors.pink},

    -- spring (pivot at bottom center on both sprites so it extends correctly)
    spring                              = {    10, 4,    2, 1,   10,  2,       colors.pink},
    spring_extended                     = {    10, 5,    2, 2,   10, 10,       colors.pink}
  },
  function (params)
