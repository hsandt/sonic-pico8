...
describe('world (with mock tiles data setup)', function ()
  ...
  describe('angle_to_quadrant', function ()
    ...
    it('should return quadrant to down for slope_angle: 1-0.124', function ()
      assert.are_equal(directions.down, world.angle_to_quadrant(1-0.124))
    end)

    it('should return quadrant to down for slope_angle: 0', function ()
      assert.are_equal(directions.down, world.angle_to_quadrant(0))
    end)

    it('should return quadrant to down for slope_angle: 0.124', function ()
      assert.are_equal(directions.down, world.angle_to_quadrant(0.124))
    end)

    it('should return quadrant to right for slope_angle: 0.25-0.125', function ()
      assert.are_equal(directions.right, world.angle_to_quadrant(0.25-0.125))
    end)
    ...
    it('should return quadrant to up for slope_angle: 0.5-0.124', function ()
      assert.are_equal(directions.up, world.angle_to_quadrant(0.5-0.124))
    end)
    ...
    it('should return quadrant to left for slope_angle: 0.75-0.125', function ()
      assert.are_equal(directions.left, world.angle_to_quadrant(0.75-0.125))
    end)
