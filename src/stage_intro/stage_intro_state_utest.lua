  ...
  describe('(with instance)', function ()
    ...
    describe('on_enter', function ()
      ...
      setup(function ()
        ...
        stub(_G, "reload")
        stub(stage_intro_state, "scan_current_region_to_spawn_waterfalls")
      ...
      teardown(function ()
        ...
        reload:revert()
        stage_intro_state.scan_current_region_to_spawn_waterfalls:revert()
      ...
      after_each(function ()
        ...
        reload:clear()
        stage_intro_state.scan_current_region_to_spawn_waterfalls:clear()
      ...
      it('should call reload for stage1, map 00 (hardcoded) and scan_current_region_to_spawn_waterfalls', function ()
        state:on_enter()

        assert.spy(reload).was_called(4)  -- normally 1 but 3 unrelated call for runtime data
        assert.spy(reload).was_called_with(0x2000, 0x2000, 0x1000, "data_stage1_00.p8")

        -- ! it should also set loaded_map_region_coords to vector(3, 1) in the middle
        -- but since just after it is set again, we cannot test that (unless we extract a method)

        assert.spy(stage_intro_state.scan_current_region_to_spawn_waterfalls).was_called(1)
      ...
      it('should call reload for stage tiles, Sonic main sprites (general memory storage) and stage1, map 01 (hardcoded)', function ()
        ...
        assert.spy(reload).was_called(4)  -- normally 3, but 1 unrelated call for waterfalls (00)
    ...
    describe('render', function ()
      ...
      it('should call render_background, render_waterfalls, render_stage_elements, render_overlay', function ()
        state:render()
