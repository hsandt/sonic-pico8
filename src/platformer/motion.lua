...
function ground_query_info:_init(tile_location, signed_distance, slope_angle)
...
function air_motion_result:_init(tile_location, position, is_blocked_by_wall, is_blocked_by_ceiling, is_landing, slope_angle)
