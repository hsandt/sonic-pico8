...
describe('signed_speed_to_direction', function ()
  it('should -5 => left', function ()
    assert.are_equal(horizontal_directions.left, signed_speed_to_direction(-5))
  end)
  it('should 2 => right', function ()
    assert.are_equal(horizontal_directions.right, signed_speed_to_direction(2))
  end)
  it('should 0 => assert', function ()
    assert.has_error(function ()
      signed_speed_to_direction(0)
    end)
  end)
end)
...
describe('oppose_direction', function ()
  it('should left => right', function ()
    assert.are_equal(directions.right, oppose_direction(directions.left))
  end)
  it('should right => left', function ()
    assert.are_equal(directions.left, oppose_direction(directions.right))
  end)
  it('should up => down', function ()
    assert.are_equal(directions.down, mirror_direction_y(directions.up))
  end)
  it('should down => up', function ()
    assert.are_equal(directions.up, mirror_direction_y(directions.down))
  end)
end)

describe('mirror_direction_x', function ()
  it('should left => right', function ()
    assert.are_equal(directions.right, mirror_direction_x(directions.left))
  end)
  it('should right => left', function ()
    assert.are_equal(directions.left, mirror_direction_x(directions.right))
  end)
  it('should up => up', function ()
    assert.are_equal(directions.up, mirror_direction_x(directions.up))
  end)
  it('should down => down', function ()
    assert.are_equal(directions.down, mirror_direction_x(directions.down))
  end)
end)

describe('+ mirror_direction_y', function ()
  it('should up => down', function ()
    assert.are_equal(directions.down, mirror_direction_y(directions.up))
  end)
  it('should down => up', function ()
  ...
  it('should left => left', function ()
    assert.are_equal(directions.left, mirror_direction_y(directions.left))
  end)
  it('should right => right', function ()
    assert.are_equal(directions.right, mirror_direction_y(directions.right))
  end)
end)

describe('rotate_direction_90_cw', function ()
  it('should left => up', function ()
    assert.are_equal(directions.up, rotate_direction_90_cw(directions.left))
  end)
  it('should up => right', function ()
    assert.are_equal(directions.right, rotate_direction_90_cw(directions.up))
  end)
  it('should right => down', function ()
    assert.are_equal(directions.down, rotate_direction_90_cw(directions.right))
  end)
  it('should down => left', function ()
    assert.are_equal(directions.left, rotate_direction_90_cw(directions.down))
  end)
end)

describe('rotate_direction_90_ccw', function ()
  it('should left => down', function ()
    assert.are_equal(directions.down, rotate_direction_90_ccw(directions.left))
  end)
  it('should down => right', function ()
    assert.are_equal(directions.right, rotate_direction_90_ccw(directions.down))
  end)
  it('should right => up', function ()
    assert.are_equal(directions.up, rotate_direction_90_ccw(directions.right))
  end)
  it('should up => left', function ()
    assert.are_equal(directions.left, rotate_direction_90_ccw(directions.up))
  end)
end)
