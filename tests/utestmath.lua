...
describe('mirror_rotate_90_cw', function ()
  it('should left => up', function ()
    assert.are_equal(directions.up, mirror_rotate_90_cw(directions.left))
  end)
  it('should up => right', function ()
    assert.are_equal(directions.right, mirror_rotate_90_cw(directions.up))
  end)
  it('should right => down', function ()
    assert.are_equal(directions.down, mirror_rotate_90_cw(directions.right))
  end)
  it('should down => left', function ()
    assert.are_equal(directions.left, mirror_rotate_90_cw(directions.down))
  end)
end)

describe('mirror_rotate_90_ccw', function ()
  it('should left => down', function ()
    assert.are_equal(directions.down, mirror_rotate_90_ccw(directions.left))
  end)
  it('should down => right', function ()
    assert.are_equal(directions.right, mirror_rotate_90_ccw(directions.down))
  end)
  it('should right => up', function ()
    assert.are_equal(directions.up, mirror_rotate_90_ccw(directions.right))
  end)
  it('should up => left', function ()
    assert.are_equal(directions.left, mirror_rotate_90_ccw(directions.up))
  end)
end)
