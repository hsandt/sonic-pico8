...
-- width of characters not using default_char_width (includes space)
...
local ending_credits_roles = {
  {"original games", to_custom_font("sonic team")},
  {"programming", to_custom_font("komehara")},
  {"bgm adaptation: famitracker", to_custom_font("danooct1")},
  {"bgm and sfx adaptation: pico-8", to_custom_font("komehara")},
  {"art adaptation", to_custom_font("komehara")},
  {"special thanks", to_custom_font("sonic retro\non sonic physics")},
  {"special thanks", to_custom_font("tasvideos\non sonic physics")},
  {"special thanks", to_custom_font("the spriters\nresource")},
}
