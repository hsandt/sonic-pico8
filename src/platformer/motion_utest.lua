  ...
  describe('air_motion_result', function ()
    ...
    describe('init', function ()
      ...
      it('should create a air_motion_result with position, is_blocked_by_wall, is_blocked_by_ceiling, is_landing, slope_angle', function ()
        ...
        assert.are_same({location(2, 1), vector(2, 3), true, false, true, -0.25}, {gmr.tile_location, gmr.position, gmr.is_blocked_by_wall, gmr.is_blocked_by_ceiling, gmr.is_landing, gmr.slope_angle})
      end)
    ...
    describe('is_blocked_along', function ()
      ...
      it('return false if direction is left and is_blocked_by_wall is false', function ()
        local gmr = air_motion_result(nil, vector(2, 3), false, false, false)
      ...
      it('return true if direction is left and is_blocked_by_wall is true', function ()
        local gmr = air_motion_result(nil, vector(2, 3), true, false, false)
      ...
      it('return true if direction is up and is_blocked_by_ceiling is true', function ()
        local gmr = air_motion_result(nil, vector(2, 3), false, true, false)
      ...
      it('return true if direction is down and is_landing is true', function ()
        local gmr = air_motion_result(location(2, 1), vector(2, 3), false, false, true)
    ...
    describe('_tostring', function ()
      ...
      it('should return "air_motion_result(vector(2, 3), true, false, true, -0.25)"', function ()
        local gmr = air_motion_result(location(2, 1), vector(2, 3), true, false, true, -0.25)
        assert.are_equal("air_motion_result(location(2, 1), vector(2, 3), true, false, true, -0.25)", gmr:_tostring())
      end)
